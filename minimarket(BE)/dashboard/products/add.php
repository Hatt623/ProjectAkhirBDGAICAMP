...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row m-5">
                <div class="col">
                    <div class="row">
                        <label for="prd-thumb">Poster: </label>
                            <input class="btn" type="file" name="prd-thumb" required>
                    </div>
                </div>
                <input type="hidden" name="id" >
                <input type="hidden" name="oldPoster">
                <div class="col">
                        <label for="prd-nama">Nama Produk: </label>
                        <input type="text" name="prd-nama" class="form-control"  required >
                        <label for="prd-harga">Harga: </label>
                        <input type="number" min="0" name="prd-harga" class="form-control" required >
                </div>
                <div class="col">
