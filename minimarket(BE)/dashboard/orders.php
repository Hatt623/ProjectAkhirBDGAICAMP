    ...
    <div class="d-flex " id="wrapper">
        ...
        <div class="bg-white border-end" id="sidebar-wrapper">
            ...
            <div class=" list-group list-group-flush">
                <a class="list-group-item list-group-item-action list-group-item-light p-4" href="index.php">
                    <h5><i class="bi bi-speedometer"></i> Dashboard</h5>
                </a>
                <a class="list-group-item list-group-item-action list-group-item-light p-4 mt-3" href="admins.php">
                    <h5><i class="bi bi-person-bounding-box"></i> Manage Admin</h5>
                </a>
                <a class="list-group-item list-group-item-action list-group-item-light p-4 mt-3" href="users.php">
                    <h5><i class="bi bi-people-fill"></i> Manage Users</h5>
                </a>
                <a class="list-group-item list-group-item-action list-group-item-light p-4 mt-3" href="orders.php">
                    <h5><i class="bi bi-bar-chart-fill"></i> Manage Orders</h5>
                </a>
            </div>
        </div>
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="sb-topnav navbar navbar-expand navbar-dark bg-warning">
                <!-- Navbar Brand-->
                <button class="btn text-white mx-2" id="sidebarToggle">
                            ...
                            <table class="table table-striped table-hover text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Status Pembayarn</th>
                                        <th scope="col">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach($orders as $ord) :?>
                                    <?php ($ord['ord-status'] == 'UNPAID') ? $class = 'text-danger' : $class = 'text-success'; ?>
                                    <tr>
                                        <th scope="row"><?=$ord['ord-id']?></th>
                                        <td><?=$ord['ord-title']?></td>
                                        <td><?=$ord['ord-price']?></td>
                                        <td><?=$ord['ord-qty']?></td>
                                        <td><?=$ord['ord-username']?></td>
                                        <td><?=$ord['ord-adress']?></td>
                                        <td class="<?=$class?>"><?=$ord['ord-status']?></td>
                                        <td><a href="pay.php?id=<?=$ord['ord-id']?>">Bayar</a></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
